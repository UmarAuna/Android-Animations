...
import kotlinx.android.synthetic.main.activity_transition_example1.*

class TransitionExample1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_transition_example1)
